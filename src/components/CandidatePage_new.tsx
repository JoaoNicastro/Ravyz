...
export function CandidatePage({ candidateData, onBack, onLogout }: CandidatePageProps) {
  ...
  const candidate = {
    ...defaultCandidate,
    ...candidateData,
    technicalSkills: candidateData?.technicalSkills || defaultCandidate.technicalSkills,
    softSkills: candidateData?.softSkills || defaultCandidate.softSkills,
    dreamJob: {
      ...defaultCandidate.dreamJob,
      ...(candidateData?.dreamJob || {}),
      industries: candidateData?.dreamJob?.industries || candidateData?.dreamJob?.industry || defaultCandidate.dreamJob.industries,
      topValues: candidateData?.dreamJob?.topValues || defaultCandidate.dreamJob.topValues
    }
  };
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6">
          ...
          <div className="space-y-3">
            {(candidate.technicalSkills || []).slice(0, 4).map((skill: any, index: number) => (
