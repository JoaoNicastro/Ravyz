                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-sm text-ravyz-green font-medium">
                          {Math.round(((opportunity.salaryRange.min - currentJobData.currentSalaryMax) / currentJobData.currentSalaryMax) * 100)}% 
                          a 
                          {Math.round(((opportunity.salaryRange.max - currentJobData.currentSalaryMax) / currentJobData.currentSalaryMax) * 100)}% 
                          de aumento
                        </p>
                      </div>
                      <div>
                    ...
                    <div className="grid grid-cols-3 gap-3 pt-2 border-t border-gray-200">
                      <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                        <Button 
                          ...
                          className="w-full bg-ravyz-green hover:bg-ravyz-green/90 text-white"
                          size="sm"
                        >
                      ...
                      <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                        <Button 
                          ...
                          variant="outline"
                          className="w-full border-ravyz-blue text-ravyz-blue hover:bg-ravyz-blue/5"
                          size="sm"
                        >
                      ...
                      <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                        <Button 
                          ...
                          variant="outline"
                          className="w-full border-ravyz-orange text-ravyz-orange hover:bg-ravyz-orange/5"
                          size="sm"
                        >
